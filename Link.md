...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <Link label="Default Link" href="#" icon={IconWarning} />
            </td>
            <td>
                <Link label="Default Link" href="#" classes="hover" />
            </td>
        </tr>
        <tr>
            <td>
                <Link label="Default Link" href="#" priority="primary" />
            </td>
            <td>
                <Link label="Default Link" href="#" priority="primary" icon={IconWarning} />
            </td>
            <td>
                <Link label="Default Link" href="#" priority="primary" classes="hover" />
            </td>
        </tr>
        <tr>
            <td>
                <Link label="Default Link" href="#" priority="secondary" />
            </td>
            <td>
                <Link label="Default Link" href="#" priority="secondary" icon={IconWarning} />
            </td>
            <td>
                <Link label="Default Link" href="#" priority="secondary" classes="hover" />
            </td>
        </tr>
        <tr>
            <td>
                <Link label="Default Link" href="#" priority="tertiary" />
            </td>
            <td>
                <Link label="Default Link" href="#" priority="tertiary" icon={IconWarning} />
            </td>
            <td>
                <Link label="Default Link" href="#" priority="tertiary" classes="hover" />
            </td>
        </tr>
    </tbody>
</table>
